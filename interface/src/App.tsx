...
const moduleAddress = "0x558d8ff240a01dbfdbc86b24c46743bbbebcce9319873908355cda2d206b208f";
    ...
    return (
      <CenteredWrapper>
        ...
        <CalculatorWrapper>
          ...
          <ButtonGrid>
            <Button color="grey" onClick={() => { setInput(''); setResult(''); }} disabled={!isActive}>C</Button>
            <Button color="grey" onClick={() => setInput(input.slice(0, -1))} disabled={!isActive}>←</Button>
            ...
            <OperationButton onClick={() => handleOperationClick('/')} disabled={!isActive}>÷</OperationButton>
            {[7, 8, 9].map(num => (
              <Button key={num} color="grey" onClick={() => handleButtonClick(num.toString())} disabled={!isActive}>{num}</Button>
            ))}
            ...
            <OperationButton onClick={() => handleOperationClick('+')} disabled={!isActive}>+</OperationButton>
            <Button wide color="grey" onClick={() => handleButtonClick('0')} disabled={!isActive}>0</Button>
            <Button color="grey" onClick={() => handleButtonClick('.')} disabled={!isActive}>.</Button>
